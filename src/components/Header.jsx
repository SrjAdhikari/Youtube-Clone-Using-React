...
import profile_pic from "../assets/suraj.jpg";
...
const Header = () => {
    ...
    // Handles search on Enter key press or search button click
    ...
    // Extracting page name from the current URL to conditionally render components
        ...
        <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
            ...
            <div className="flex h-5 items-center">
                ...
                <Link to="/" className="flex h-5 items-center">
                    <img className="h-full hidden md:block" src={ytLogo} alt="Youtube Logo" />
            ...
            <div className="group flex items-center">
                <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
                    <div className="w-10 items-center justify-center hidden md:flex">
